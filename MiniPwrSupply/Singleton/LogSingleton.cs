...
namespace MiniPwrSupply.Singleton
{
    ...
    //{
    //    private const string DLL_PATH = "asecl_dll\\Utility\\JLink\\ASECL_JLink.dll";

    //    [DllImport(DLL_PATH, SetLastError = true, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
    //    public static extern bool ReadFICR_DeviceID_Nordic52840BySWDRegister(ref UInt64 result);
    //}
}